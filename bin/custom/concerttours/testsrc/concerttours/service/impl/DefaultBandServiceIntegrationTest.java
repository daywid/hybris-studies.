...
// @IntegrationTest
// public class DefaultBandServiceIntegrationTest {
...
//     private static final String BAND_HISTORY = "New contemporary, 7-piece Jaz unit from Londom, formed in 2015";
...
//         } 
//         catch (InterruptedException exc) {
//             // this istance of a bandmodel will be used by the tests
//             bandModel = modelService.create(BandModel.class);
//             bandModel.setCode(BAND_CODE);
//             bandModel.setName(BAND_NAME);
//             bandModel.setAlbumSales(ALBUMS_SOLD);
