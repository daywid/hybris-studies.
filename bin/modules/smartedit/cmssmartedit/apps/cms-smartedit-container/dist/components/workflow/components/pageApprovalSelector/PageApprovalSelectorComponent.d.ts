...
import { CrossFrameEventService, IDropdownMenuItem, IIframeClickDetectionService, IWaitDialogService, LogService, SmarteditRoutingService, IPageService, CmsApprovalStatus, WorkflowService } from 'smarteditcommons';
