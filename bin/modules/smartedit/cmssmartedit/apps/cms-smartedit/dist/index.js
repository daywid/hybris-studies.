...
let /* @ngInject */ SlotVisibilityComponent = class /* @ngInject */ SlotVisibilityComponent {
    constructor(catalogService, componentSharedService, editorModalService, componentVisibilityAlertService, catalogVersionPermissionService, logService, cdr) {
        this.catalogService = catalogService;
        this.componentSharedService = componentSharedService;
        this.editorModalService = editorModalService;
        this.componentVisibilityAlertService = componentVisibilityAlertService;
...
SlotVisibilityComponent.$inject = ["catalogService", "componentSharedService", "editorModalService", "componentVisibilityAlertService", "catalogVersionPermissionService", "logService", "cdr"];
__decorate([
    core.Input(),
    __metadata("design:type", Object)
