...
describe('SlotVisibilityComponent', () => {
    ...
    describe('openEditorModal', () => {
        it('WHEN called THEN it opens a modal with the given component uuid AND performs a check for component visibility', async () => {
        ...
        it('handles openAndRerenderSlot exception properly', async () => {
            component.component = ({
                typeCode: null,
                uuid: null
            } as unknown) as ICMSComponent;
